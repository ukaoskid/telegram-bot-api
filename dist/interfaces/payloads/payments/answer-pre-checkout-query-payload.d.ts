/**
 * Answer Pre Checkout Query API Payload.
 */
export interface IAnswerPreCheckoutQueryPayload {
    /**
     ...
     * to proceed with the checkout (e.g. "Sorry, somebody just bought the last of our amazing black T-shirts while
